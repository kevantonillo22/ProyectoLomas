		...
		var id;
			...
			function format(d) {
				<% if(algunPermiso) { 
					...
					if(asignar) out.println("'<td><a href=\"../rol/funcionesRol.jsp?rol=' + d.id +'&nombre='+d.nombre+ '\"><button class=\"btn btn-default\" >Asignar funciones</button></a></td>' + ");
					out.println("	\'</tr>\' + ");
					out.println("\'</table>\';"); 
				} else {
					out.print("return '';"); 
