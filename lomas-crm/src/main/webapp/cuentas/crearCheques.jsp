...
<html lang="en">
										...
										<div class="col-sm-2"></div>
				               			<div class="col-sm-8 col-xs-12">
											...
											<div class="form-group col-xs-6">
												...
												<input type="text" class="form-control" id="txtLugar" placeholder="Lugar" maxlength="50" onkeypress="return permite(event, 'num_car')">
											</div>
											<div class="form-group col-xs-6" >
											...
											<div class="form-group col-xs-12">
												...
												<input type="text" class="form-control" id="txtMotivo" placeholder="Motivo" maxlength="100" onkeypress="return permite(event, 'num_car')">
											</div>
											<div class="form-group col-xs-12">
	...
	<div class="modal fade" id="modal-nuevo-cheque" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
		...
		<script src="/lomas-crm/js/cuentas/crearCheque.js"></script>
