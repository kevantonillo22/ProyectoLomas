...
public class General_BE {
	
	//Configuración Global de Base de datos
	//public static final String DB_CADENA_CONEXION = "jdbc:postgresql://ec2-54-201-189-106.us-west-2.compute.amazonaws.com:18381/usac_crm_odontologia";
	//public static final String DB_USUARIO_CONEXION = "postgres";
	//public static final String DB_PASSWORD = "197AAB75663FD_db_FOUS4C_!"; //"197AAB75663FD_db_FOUS4C_!"

	public static final String DB_CADENA_CONEXION = "jdbc:postgresql://localhost:5432/crm_lomas";
	public static final String DB_USUARIO_CONEXION = "crm_web";
	public static final String DB_PASSWORD = "Hola221234";//"Hola221234"; 
