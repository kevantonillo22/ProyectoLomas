...
public class Direccion_BLL {
	 ...
	 * @return Resultado_BE
	 * @throws Exception
	 * @Descripcion Método que realiza un insert en la tabla de direccion
	 ********************************************************************/
		...
		if (conexion != null) {
			...
			try {
				...
				if (creacion_resultado.re_exitoso) {
					...
					bitacora.bi_descripcion = "Se realizó insert en la tabla de direccion";
	 ...
	 * @throws Exception
	 * @Descripcion Método que lista de la tabla de dirección
	 ********************************************************************/
	 ...
	 * @return Resultado_BE
	 * @throws Exception
	 * @Descripcion Método que hace un update a la tabla de crm_direccion
	 ********************************************************************/
